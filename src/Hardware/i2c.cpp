...
Status I2cMultiplexerChannel::hardware_start() {
  _multiplexer.lock();
...
Status I2cMultiplexerChannel::hardware_stop() {
  _multiplexer.lock();
...
Status I2cMultiplexerChannel::hardware_reset() {
  _multiplexer.lock();
...
uint8_t I2cMultiplexerGpioID::get_total_channels() const {
  return _channels;
}
